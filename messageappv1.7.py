...
class MessageToGodApp(App):
    def build(self):
        ...
        self.messages_label = Label(text="", color=(.8, 0, 0.5, 1), size_hint_y=None)  # Set the text color to dark blue and make the label expandable in the vertical direction
